    ...
    <div className="h-[100vh] w-[100%]">
      ...
      <div className="flex absolute">
        <div className="w-[60%] h-[auto] ml-0 relative">
          <div className="">
            <img
              src="\LoginPageImages\LoginCover.png"
              alt="Img"
          ...
          <div className="absolute top-0 ml-[110px] mt-[375px] text-[18.96px] text-[#FFFFFF] font-['Inter'] font-normal leading-[36.03px]">
            The organized / unorganized sector of Indian citizen <br /> across
            the geography / Income category.
          </div>
          ...
          <img
            className="absolute top-0 w-[31.76px] h-[31.29px] ml-[581px] mt-[480px]"
            src="\LoginPageImages\vector.png"
            alt=""
          />
        </div>
